...
class DoctrineClearQuery extends Command
{
     ...
     * @var string
     */
    protected $signature = 'doctrine:clear-cache:query {--flush : If defined, cache entries will be flushed instead of deleted/invalidated}';
    ...
    public function handle()
    {
        ...
        $this->comment('Clearing all Query cache entries');
